...
/**
 * Regras Os navios podem ser colocados horizontalmente ou verticalmente, mas
 * não na diagonal. Todo navio deve estar completamente na grade. Nenhum navio
 * pode estar com alguma parte do lado de fora. Os navios não podem ficar
 * sobrepostos. Para dar um tiro, escolha um quadrado sobre a grade, diga suas
 * coordenadas de acordo com as linhas e as colunas na parte esquerda e superior
 * da grade. Por exemplo, o quadrado no canto superior esquerdo da grade é
 * chamado de "1-1", uma vez que está localizado na linha 2 e na coluna 2. Se o
 * primeiro jogador atingir um quadrado com um navio, o jogador 2 deve dizer
 * "Fogo!" Simbolo 'x' onde foi atingido um barco Se cada quadrado de um navio
 * levar um tiro, o navio será afundado. O jogador deve então informar o seu
 * adversário dizendo "Afundou meu ___," indicando qual tipo de navio foi
 * afundado. Tiros na água terão o simbolo 'a' Continue atirando até que um
 * jogador perca todos os seus navios. Os jogadores devem se alternar dando um
 * tiro de cada vez, independente de acertar ou não. Quem conseguir afundar
 * todos os navios de seu oponente primeiro, ganha o jogo.
 *
